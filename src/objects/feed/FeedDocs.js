...
FeedDocs.default = {
  ...
  classes: {
    wrapper: 'Adds classes to to the wrapper for the whole widget. There are two classes that are available to change the Feed items layout to 2 or 3 columns: "o-feed--column-2" or "o-feed--column-3".',
