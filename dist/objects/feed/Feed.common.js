  ...
  _createClass(Feed, [{
    ...
    value: function init() {
      ...
      forEach(config.rssUrl, function (url, index) {
        ...
        _this._request(config, url).then(function (response) {
          // Process the data
          data.push(_this._process(JSON.parse(response), _this._settings)); // When all feeds have been requested, merge the data and compile

          if (data.length === config.rssUrl.length) {
            _this._merge(data, _this._settings);
    ...
    value: function _request(config, url) {
      return new Promise(function (resolve, reject) {
        ...
        xhr.open('GET', "".concat(config.rssToJson, "?rss_url=").concat(url), true);
        xhr.send();
        xhr = null;
      });
    }
